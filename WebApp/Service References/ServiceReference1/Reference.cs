...
namespace WebApp.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Encrypt", ReplyAction="http://tempuri.org/IService1/EncryptResponse")]
        System.Threading.Tasks.Task<string> EncryptAsync(string plainText, string passPhrase);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/Decrypt", ReplyAction="http://tempuri.org/IService1/DecryptResponse")]
        System.Threading.Tasks.Task<string> DecryptAsync(string cipherText, string passPhrase);
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WebApp.ServiceReference1.IService1>, WebApp.ServiceReference1.IService1 {
        ...
        public string Encrypt(string plainText, string passPhrase) {
            return base.Channel.Encrypt(plainText, passPhrase);
        }
        
        public System.Threading.Tasks.Task<string> EncryptAsync(string plainText, string passPhrase) {
            return base.Channel.EncryptAsync(plainText, passPhrase);
        }
        
        public string Decrypt(string cipherText, string passPhrase) {
            return base.Channel.Decrypt(cipherText, passPhrase);
        }
        
        public System.Threading.Tasks.Task<string> DecryptAsync(string cipherText, string passPhrase) {
            return base.Channel.DecryptAsync(cipherText, passPhrase);
        }
